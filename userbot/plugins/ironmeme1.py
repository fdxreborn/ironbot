...
@borg.on(admin_cmd(pattern="type <text>"))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(admin_cmd(pattern=r"solar"))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.1
...
@borg.on(admin_cmd(pattern=r"shout <text>"))
...
async def _(event):
    ...
    animation_chars = [        
            ...
            "🔵🔵🔵⬜⬜⬜🔴🔴🔴\n🔵🔵🔵⬜⬜⬜🔴🔴🔴\n🔵🔵🔵⬜⬜⬜🔴🔴🔴",
            "🔴🔴🔴⬜⬜⬜🔵🔵🔵\n🔴🔴🔴⬜⬜⬜🔵🔵🔵\n🔴🔴🔴⬜⬜⬜🔵🔵🔵",
           f"{DEFAULTUSER} **Police Service Here**"
 ]
