...
async def update(event, repo, ups_rem, ac_br):
    ...
    await event.edit("**B E R H A S I L UP**")
    await event.edit("**B E R H A S I L UPD**")
    await event.edit("**B E R H A S I L UPDA**")
    await event.edit("**B E R H A S I L UPDAT**")
    await event.edit("**B E R H A S I L UPDATE**")
