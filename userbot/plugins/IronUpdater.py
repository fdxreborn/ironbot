...
async def update(event, repo, ups_rem, ac_br):
    ...
    await event.edit("**B**")
    await event.edit("**BE**")
    await event.edit("**BER**")
    await event.edit("**BERH**")
    await event.edit("**BERHA**")
    await event.edit("**BERHAS**")
    await event.edit("**BERHASI**")
    await event.edit("**BERHASIL**")
    await event.edit("**BERHASIL U**")
    await event.edit("**BERHASIL UP**")
    await event.edit("**BERHASIL UPD**")
    await event.edit("**BERHASIL UPDA**")
    await event.edit("**BERHASIL UPDAT**")
    await event.edit("**BERHASIL UPDATE**")
